...
아인슈타인의 **특수 상대성 이론**에 대한 자세한 설명은 이후 \<시간과 공간\> 파트에서 다룰 것이기 때문에 일단은 넘어가겠습니다. 지금으로서는 다음 두 꼭지 정도만 알아두시면 됩니다.

1. 오직 두 가지 전제 — 모든 관성 좌표계의 물리 법칙은 동등하다는 전제와, 광속은 언제나 같다는 전제 — 로부터, 뉴턴 물리학과 맥스웰 방정식을 통합할 수 있다.
2. 단, 시공간에 대한 기존의 접근을 완전히 달리해야 한다. 특히, 빠르게 움직일수록 공간은 수축하고 시간은 느려진다.<a href="#sub4" id="sup4"><sup>4</sup></a>

따라서 상대성 이론에 의하면 에테르는 존재하지 않습니다.
