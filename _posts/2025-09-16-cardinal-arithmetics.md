...
> **정의.** 각 $i \in I$에 대해 $A\_i$가 기수 $\kappa\_i$인 쌍으로 서로소인 집합족 $\lbrace A_i \rbrace $가 주어졌을 때, 다음과 같이 정의한다.
>
> $$
...
> **정의.** 각 $i \in I$에 대해 $A\_i$가 기수 $\kappa\_i$인 집합족 $\lbrace A_i \rbrace $가 주어졌을 때, 다음과 같이 정의한다.
>
> $$
