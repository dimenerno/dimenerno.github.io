...
var documents = [{
    ...
    "url": "/404.html",
    "title": "404",
    "body": "404이 페이지는 공허하네요하단의 검색 바를 사용하거나, 이 링크를 통해서 저의 메인 페이지로 돌아오실 수 있습니다. "
    }, {
    "id": 1,
    "url": "/about",
    "title": "안녕하세요, 디멘입니다.",
    "body": "저는 카이스트 전산학부에 재학 중인 대학생입니다. 수학, 언어, 그리고 바흐를 좋아합니다. 취미는 컴퓨터로 이것저것 만드는 것이고,비전은 모두에게 재미있는 교육의 기회를 주는 것입니다. 중학교 때 수학에 재미를 느끼고 시작한 블로그가 저의 첫 창작 활동이었습니다. 이후 고등학교 때 유사수학 페이지를 관리하며 더 많은 사람들에게 수학의 재미를 알리고자 하였고,현재는 재미있는 학습의 기회를 제공해주는 무료 플랫폼을 만들고자 개발을 공부하고 있습니다. 이 블로그는 제가 개발한 것과 공부한 것을 기록하는 공간입니다. 블로그의 이름인 Stilla는 라틴어로 ‘물방울’이라는 의미입니다. 하늘에서 조금씩 떨어지는 물방울이 이윽고 커다란 연못을 이루듯,저의 하루하루의 노력이 언젠가 커다란 뜻을 이뤄내기를 바라고 있습니다. 이 블로그는 WowThemes. net의 Memoirs Jekyll Theme 테마를 베이스로 하여 만들어졌으며, Jekyll과 Github으로 호스팅됩니다. "
    }, {
    "id": 2,
    "url": "/categories",
    "title": "Categories",
    ...
    "url": "/",
    "title": "Home",
    "body": "  {% assign list = paginator. posts | sort: 'order' %}  {% for post in list %}    {% include postbox. html %}  {% endfor %}  {% include pagination. html %}"
    }, {
    "id": 5,
    "url": "/robots.txt",
    "title": "",
    ...
    "url": "/stilla/",
    "title": "스틸라키스",
    "body": "2021/01/30 - 우리 모두 교양이 가지는 힘을 알고 있습니다. 교양 있는 사람들은 새로운 학문을 공부하는 데 있어 다른 사람들보다 진입 장벽이 낮고, 다양한 분야의 사람들과 교류를 하는 데 어려움이 없고, 사고의 수준도 훨씬 깊으며, 무엇보다 멋있어 보입니다. 하지만 교양인이 되는 것은 쉬운 일이 아닙니다. 무엇보다 교양을 쌓고자 하여도, 어디서부터 시작해야 하는지가 너무 막막합니다. 무작정 서점에서 ‘있어 보이는’ 책을 샀다가는 어렵고 지루한 내용에 금새 질려서 도중에 포기하기 일쑤이죠. 스틸라 루키스는 여러분들이 부담없이, 차곡차곡 교양을 쌓을 수 있도록 도와주는 앱입니다. 스틸라 루키스는 매일매일 여러분들에게 아무런 배경 지식이 없어도 쉽게 읽을 수 있는 짧은 교양 지식을 푸쉬해 줍니다. 여러분들이 공부하고 싶은 분야와, 여유로운 시간대를 입력하면, 스틸라 루키스는 정해진 시간대에 여러분의 관심 분야 중 하나의 교양 지식을 랜덤으로 푸쉬해줍니다. 이렇게 매일매일 5분만 시간을 들이며 교양을 쌓다보면 어느덧 여러분의 교양 지식은 이전과 몰라볼 정도로 성장해 있을 겁니다! 🎉 스틸라키스는 스틸라 루키스(Stilla Lucis)에서 따온 이름이며, Stilla Lucis는 라틴어로 ‘빛의 물방울’이라는 뜻입니다. 지식은 우리가 인생을 살아가는 데 길잡이가 되어주는 등대의 한 줄기 빛과도 같습니다. 스틸라 루키스는 마치 자그만한 물방울과도 같은 부담되지 않는 지식을 여러분의 머리에 떨어뜨려 드리겠다는 의미에서 지은 이름입니다. 하지만 끊임없는 물방울이 바위를 쪼개듯, 매일매일 여러분이 공부한 지식은 어느덧 여러분을 훨씬 더 폭넓은 교양을 갖춘 사람으로 만들어 줄 것입니다. 이 프로젝트를 지원하고 싶으시다면 🍡디멘이에게 찹쌀떡 사주기를 클릭하여 도와주실 수 있습니다. 여러분의 지원은 저에게 무엇보다 큰 힘이 됩니다😇 "
    }, {
    "id": 8,
    "url": "/chrome/",
    "title": "에스페로",
    "body": "2021/01/29 - 크라셴이라는 언어학자는 언어를 학습하는 방법에 대해 오랜 기간 연구했습니다. 그 결과, 그는 단어의 철자와 뜻을 무작정 암기하는 학습은 매우 비효율적이라는 것을 알아냈습니다. 대신 문맥을 통해 단어의 뜻을 자연스럽게 습득하는 학습이 훨씬 효율적이었습니다. 이 앱은 크라셴의 언어 학습 모델을 응용하기 위해 만들어졌습니다. 이 크롬 확장자는 사용자가 읽고 있는 글에서 일부 단어를 영어나 스페인어 등의 외국어로 바꿔칩니다. 하지만 일부 단어만 바꿔치기 때문에, 대부분의 경우 학습자는 문맥 상에서 바꿔쳐진 외국어 단어가 무슨 뜻인지 유추할 수 있습니다. 이러한 자연스러운 뜻의 유추를 통해 단어 습득을 용이하게 함으로써 언어 학습을 더욱 효율적으로 만드는 것이 이 확장자의 목표입니다. 현재 개발 중인 이 확장자의 기능은 아래와 같습니다.  토플 단어장, 스페인어 기초 100 단어장 등 여러 단어장 중에서 자신의 필요와 수준에 맞는 단어장을 선택할 수 있습니다. 확장자는 단어장에 수록된 단어만 바꿔칩니다.  바꿔쳐진 단어를 클릭하면 그 단어의 뜻을 볼 수 있으며, 우측 상단 사전 링크를 클릭하면 더 자세한 의미까지 공부할 수 있습니다.  어려운 단어는 단어장에 추가하여 나중에 따로 모아볼 수 있습니다. 쉬운 단어는 더이상 바꿔치지 않도록 설정할 수 있습니다.  설정 창에서 단어를 바꾸는 빈도를 조절할 수 있습니다. 이 프로젝트를 지원하고 싶으시다면 🍡디멘이에게 찹쌀떡 사주기를 클릭하여 도와주실 수 있습니다. 여러분의 지원은 저에게 무엇보다 큰 힘이 됩니다😇 "
    }, {
    "id": 9,
    "url": "/puzzle/",
    "title": "모둠",
    "body": "2021/01/12 - Unity와 C#을 이용하여 퍼즐 게임을 만들고 있습니다. 이 퍼즐의 특징은 2차원과 3차원을 넘나들어야지만 퍼즐을 풀 수 있다는 것입니다. 게임의 목적은 플레이어가 노란색 공을 조정하여 빨간색 큐브까지 도착하는 것입니다. 빨간색 큐브는 건너편 섬에 있기 때문에 일반적인 방법으로는 도달할 수 없습니다. 그러나 아래 영상과 같이 차원을 2차원으로 줄이고, 남색 큐브를 통해 건너간 뒤, 다시 차원을 3차원으로 옮기면 빨간색 큐브에 도착할 수 있습니다. 배경음악은 녹음하려고 했던 것은 아니지만 듣기 좋으니 남겨두죠 ( ・∇・)이 퍼즐은 위와 같은 기믹을 사용하여 차원을 넘나드는 것이 특징입니다. 현재 개발 중에 있으며, 위의 기믹을 활용한 재미있는 레벨이나, 게임에 도입하면 좋을 거 같은 창의적인 장치가 떠오르신 분들은 제 블로그 좌측 상단의 메뉴 아이콘을 클릭하면 나오는 ‘문의하기’를 통해 저에게 알려주시길 바랍니다! 게임 개발에 도움을 주신 분들은 게임의 크레딧 항목에 수록해 드리겠습니다. 이 프로젝트를 지원하고 싶으시다면 🍡디멘이에게 찹쌀떡 사주기를 클릭하여 도와주실 수 있습니다. 여러분의 지원은 저에게 무엇보다 큰 힘이 됩니다😇 "
    }, {
    "id": 10,
    "url": "/youtube/",
    "title": "디멘 유튜브 채널",
